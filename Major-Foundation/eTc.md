...
- 변수의 값을 복사하여 매개변수로 전달, 메서드 내의 처리 결과가 메서드 밖의 변수에 영향 X 
...
- ##### **분류 분석**
  ...
  - 비모수적 검정 모델 
    ...
    (통계적인 가설이 필요 없음, 통계적으로 모델을 평가하는 기준이 없으므로, validation data, test data, train data로 모델을 검증해야 함)
...
- step function
  ...
  - 0을 기준으로 출력이 0이거나 1로 표현
     ...
     <img src="..\img\picture245.png" alt="img" style="zoom: 50%;" />  <img src="..\img\picture247.png" alt="img" style="zoom: 70%;" />
...
- sigmoid function(시그모이드 함수)
  ...
  - x값이 작아질 수록 0에 수렴, 커질수록 1에 수렴
     ...
     <img src="..\img\picture244.png" alt="img" style="zoom: 50%;" />    <img src="..\img\picture248.png" alt="img" style="zoom: 70%;" />
...
- ReLu function
  ...
  - 0미만은 0을 반환하고, 입력이 특정값을 넘으면 입력 그대로 반환
     ...
     <img src="..\img\picture246.png" alt="img" style="zoom: 50%;" />      <img src="..\img\picture249.png" alt="img" style="zoom: 60%;" />

- tanh 함수(하이퍼볼릭탄젠트)

  - 일정값을 넘어가면 1에 수렴, 일정값 이하는 -1에 수렴

      <img src="..\img\picture250.png" alt="img" style="zoom: 50%;" />
